...
type CreateChatRequest struct {
	...
	Usernames []string `protobuf:"bytes,1,rep,name=usernames,proto3" json:"usernames,omitempty"` // список пользователей
}
...
type CreateChatResponse struct {
	...
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // id созданного чата
}
...
type DeleteChatRequest struct {
	...
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // id чата
}
...
type SendMessageRequest struct {
	...
	From      string                 `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`           // имя отправителя
...
var file_chat_server_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x31, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52,
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0xef, 0x01, 0x0a, 0x0c, 0x43, 0x68, 0x61, 0x74,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x56, 0x31, 0x12, 0x4f, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x12, 0x21, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x5f, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x73, 0x65, 0x72,
	...
	0x65, 0x74, 0x65, 0x12, 0x21, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x5f, 0x5a, 0x5d, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x44, 0x6d, 0x69, 0x74, 0x72, 0x69, 0x69, 0x4b,
	0x75, 0x6d, 0x61, 0x63, 0x6e, 0x65, 0x76, 0x2f, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2f, 0x63, 0x68, 0x61,
...
var file_chat_server_proto_depIdxs = []int32{
	...
	0, // 1: chat_server_v1.ChatServerV1.Create:input_type -> chat_server_v1.CreateChatRequest
	2, // 2: chat_server_v1.ChatServerV1.Delete:input_type -> chat_server_v1.DeleteChatRequest
	3, // 3: chat_server_v1.ChatServerV1.SendMessage:input_type -> chat_server_v1.SendMessageRequest
	1, // 4: chat_server_v1.ChatServerV1.Create:output_type -> chat_server_v1.CreateChatResponse
